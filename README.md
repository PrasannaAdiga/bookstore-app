...
#How this application works
 - Allows user to create their billing address
 - Allows user to create their shipping address
 - Allows user yo create a shopping cart and add single/multiple cart items
 - Each cart item represents a selected product along with its required quantity
 - Allows user to create single/multiple payment methods
 - Finally, user can create an order and order items(correspond to each cart item) and do the payment by selecting a particular payment method of Stripe 
