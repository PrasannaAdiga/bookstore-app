...
public class JpaAuditorAwareImpl implements AuditorAware<String> {
    ...
    public Optional<String> getCurrentAuditor(){
        return Optional.of(((Jwt)SecurityContextHolder.getContext().getAuthentication().getPrincipal()).getClaimAsString(CartServiceConstant.ACCESS_TOKEN_EMAIL_FIELD_NAME));
    }
}
